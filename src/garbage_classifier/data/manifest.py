...
1. Read ``build_manifest`` for the public data-preparation flow.
2. Read ``load_manifest`` and ``manifest_root`` for the training-time flow.
3. Treat private helpers (names beginning with ``_``) as implementation details
   until you want to study duplicate detection and group-aware splitting.
"""
