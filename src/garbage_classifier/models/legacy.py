...
_LEGACY: dict[str, tuple[str, str, dict[str, Any] | None]] = {
    ...
    "legacy_vgg11": ("vggnet", "vgg", {"model_name": "vgg11"}),
    "legacy_vgg13": ("vggnet", "vgg", {"model_name": "vgg13"}),
    "legacy_vgg16": ("vggnet", "vgg", {"model_name": "vgg16"}),
    "legacy_vgg19": ("vggnet", "vgg", {"model_name": "vgg19"}),
    ...
    "legacy_efficientnetv2_s": ("efficientv2", "efficientnetv2_s", None),
    "legacy_efficientnetv2_m": ("efficientv2", "efficientnetv2_m", None),
    "legacy_efficientnetv2_l": ("efficientv2", "efficientnetv2_l", None),
    ...
    "legacy_swin_tiny": ("swin_transformer", "swin_tiny_patch4_window7_224", None),
}
